...
## 2.2.1 O que é um Diagrama de Sequência?
...
### 2.2.2 Diagramas de Sequência Desenvolvidos

| Diagrama                              | Descrição                                                           | Responsável | Status     |
| ------------------------------------- | ------------------------------------------------------------------- | ----------- | ---------- |
| Iniciar partida e menu principal | Representa o fluxo de abrir jogo, carregar menu, selecionar Iniciar, criar sessão e tratar erro entre Jogador, UI, MenuController e GameSession | Breno     | Em Revisão |
...
## 2.2.3 Diagrama de Sequência iniciar partida a partir do menu principal

![Diagrama de Sequencia -  Diagrama de sequencia iniciar partida.](../Assets/sequencia.png)

*Desenvolvido por: [Breno Lucena](https://github.com/BrenoLUCO)* 


## 2.2.4 Descrição do Cenário Modelado
