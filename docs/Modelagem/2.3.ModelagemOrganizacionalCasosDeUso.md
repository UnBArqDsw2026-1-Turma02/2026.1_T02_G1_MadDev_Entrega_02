...
| Pausar e Retomar Partida              | Representa os casos de uso de pausar e retomar a partida (US-49, US-50)               | Felipe       | Feito  |

---

#### 2.3.1 - Iniciar partida e navegar no menu principal 
...
O diagrama detalha as intenções de ataque do jogador e como a mecânica de ataque a distância se comporta como uma extensão funcional da ação de atacar um inimigo por meio da ultilização de projéteis.
...
#### 2.3.2 — Pausar e Retomar Partida
...
#### 2.3.3 - Iniciar partida e navegar no menu principal
...
| [Felipe Santos Veríssimo](https://github.com/verissimoo) | Adição do Diagrama de Caso de Uso Pausar/Retomar (US-49, US-50)     | v1.7   | 24/04/2026 |                                                 |                 |
| [Breno Lucena](https://github.com/BrenoLUCO)             | Adição do diagrama de casos de uso                                  | v1.8   | 23/04/2026 | [Mateus Vieira](https://github.com/matix0/)     | data            | comentario                                                                                                                       |